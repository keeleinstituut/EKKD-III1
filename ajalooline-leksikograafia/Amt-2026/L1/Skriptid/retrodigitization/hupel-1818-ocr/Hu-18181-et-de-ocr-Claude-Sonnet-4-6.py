#!/usr/bin/env python3
# Created: 2026-02-21 16-37-12
# Author: Madis Jürviste
"""
Batch OCR Processor for Hupel's Estonian-German Dictionary (1818 Edition)

This script processes JPG images of dictionary pages through the Claude Sonnet 4.6
Batch API with thinking (budget=16000) to produce structured OCR output
...
Usage:
    python Hu-18181-et-de-ocr-Claude-Sonnet-4-6.py [--start-page PAGE] [--end-page PAGE]
    python Hu-18181-et-de-ocr-Claude-Sonnet-4-6.py --dry-run
    python Hu-18181-et-de-ocr-Claude-Sonnet-4-6.py --batch-ids msgbatch_XXX,msgbatch_YYY
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler(BASE_DIR / "ocr_batch_sonnet46.log"),
    ],
)
...
ADDITIONAL_INSTRUCTIONS = (
    ...
    "# CS46: entry cut off — continues on next page\n"
...
def log_summary(batch_ids: list[str], page_stats: dict, failed_pages: list[int]):
    ...
    logger.info(f"  Thinking : enabled (budget=16000)")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Batch OCR Processor for Hupel's Estonian-German Dictionary (1818 Edition) — Sonnet 4.6"
    )
    parser.add_argument(
        "--start-page",
        type=int,
    ...
    if args.dry_run:
        ...
        if input_files:
            ...
            print(f"Thinking     : enabled (budget=16000)")
