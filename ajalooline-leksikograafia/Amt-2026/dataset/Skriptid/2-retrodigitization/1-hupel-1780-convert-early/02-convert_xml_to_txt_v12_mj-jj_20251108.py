#!/usr/bin/env python3
# Created: 2025-11-08 17-05-00
# Author: Madis Jürviste
"""
Convert Hupel 1780 XML dictionary fragments to TXT format with perfect line tracking.

This version (v12) enhances v11 with exact element-level line tracking:
1. Build all content with metadata
2. Generate final output
3. Map metadata to EXACT line numbers in final output
4. Post-hoc search in XML to find EXACT line for each element (not just entry range)
5. Write log with perfect line number accuracy for both OUTPUT and FROM
"""
    ...
    def process_entry(self, entry_elem, logger: ConversionLogger,
        ...
        for sense_elem in entry_elem.findall('sense'):
            ...
            for tr in translations:
                ...
                logger.track_output_line(line, ':tr:',
...
def main():
    ...
    output_dir = base_dir / "converted_txt_files_v12"
    log_dir = base_dir / "conversion_logs_v12"
