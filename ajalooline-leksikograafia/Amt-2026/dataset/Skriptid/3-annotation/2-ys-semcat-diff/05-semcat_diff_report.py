...
BASE = Path("Katus-ALUSANDMED/YS-Master-semcat-diff/Sem-Cat-YS-to-AMT")
...
SECTIONS = [
    ("disjoint", "≠", "No overlap",
     "ÜS assigns entirely different categories — none of the AMT tokens is confirmed."),
    ("partial", "~", "Partial overlap",
     "Some categories agree; others in the AMT annotation are not confirmed by ÜS."),
    ("ys-adds", "+", "ÜS adds categories",
     "The AMT annotation is fully confirmed, and ÜS tags additional categories."),
    ("match", "=", "Full match",
    ...
    ("amt-empty", "†", "Only ÜS has categories",
     "The AMT Sem-Cat was empty or a placeholder; ÜS supplies the only information."),
]

CHIP_TITLE = {
    "shared": "confirmed: present on both sides",
    "equiv": "equivalent label across the two vocabularies (see key)",
    "amt-only": "only in the AMT Sem-Cat — not confirmed by ÜS",
    "ys-new": "new in ÜS — absent from the AMT Sem-Cat",
}
...
<!-- No external resources: the report renders with system fonts so it works
...
<p class="key">
  ...
  <span class="chip amt-only">only in the AMT Sem-Cat</span>
