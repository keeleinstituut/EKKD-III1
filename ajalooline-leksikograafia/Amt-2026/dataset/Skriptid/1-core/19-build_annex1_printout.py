...
Layout: A4, two columns, Times New Roman 11 pt, 1-inch margins (matching the
thesis-draft docx), page numbers bottom center in 12 pt starting at 55
(matched to the thesis pagination).
...
OUT_DIR = ROOT / "output"  # in the working repo this pointed at the thesis-draft folder
